...
class CreateGameTestVersion3(TestCase):
    ...
    def test_create_game_with_previous_games(self):
        ...
        create_game_version3( self.players , games, 1)
        self.assertEqual(Chess_Game.objects.count(), 6)
        games=Chess_Game.objects.all()

        create_game_version3( self.players , games, 2)
    ...
    def test_create_game_with_previous_games_and_changing_score(self):
        ...
        players = Chess_Player.objects.filter(id__in=[1, 2, 3, 4, 5, 6])
        create_game_version3( players , games, 2)
        self.assertEqual(Chess_Game.objects.count(), 9)
        games=Chess_Game.objects.all()
...
class TestEditGameAdvanced(TestCase):
    ...
    def test_edit_game_three_rounds(self, mock_log):
        ...
        self.assertEqual(set((games[6].player1, games[6].player2)), set((players[6], players[3])))
        self.assertEqual(set((games[7].player1, games[7].player2)), set((players[4], players[7])))
        ...
        self.assertEqual(set((games[11].player1, games[11].player2)), set((players[6], players[0])))
        self.assertEqual(set((games[12].player1, games[12].player2)), set((players[4], players[8])))
        self.assertEqual(set((games[13].player1, games[13].player2)), set((players[5], players[1])))
